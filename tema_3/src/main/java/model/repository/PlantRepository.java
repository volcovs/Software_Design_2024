...
public class PlantRepository extends Observable {

    private Repository repository;
    private String dbName = "gradina_botanica";


    public PlantRepository(String dbName, Observer o) {
        this.dbName = dbName;
    ...
    public boolean addPlant(Plant plant, String imagePath) {
        String command = "INSERT INTO Plant(plant_name, species, plant_type, carnivorous, endangered, location, image) Values('";
    ...
    public Plant searchPlant(String id) {
        ...
        try {
            ...
            p = new Plant(plant_id, name, species, type, carnivorous, endangered, location, img);
    ...
    public List<Plant> plantList() {
        ...
        try {
            while(rs.next()) {
                ...
                p = new Plant(plant_id, name, species, type, carnivorous, endangered, location, image);
                plants.add(p);
            }
