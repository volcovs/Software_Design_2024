...
public class CreateDatabase {
    ...
    public void createTablePlant() {
        ...
        try {
            ...
            String query = "CREATE TABLE IF NOT EXISTS Plant (plant_id INT NOT NULL AUTO_INCREMENT primary key, " +
                    ...
                    "endangered VARCHAR(3), location VARCHAR(50));";
            s.executeUpdate(query);
    ...
    public void addInitialData() {
        ...
        try {
            Statement s = conn.createStatement();
            String query = "INSERT INTO plant(plant_name, species, plant_type, carnivorous, endangered, location) VALUES ('lalea', 'tulipa gesneriana', 'magnoliophyta', 'no', 'no', 'right entrance');";
            s.executeUpdate(query);
            query = "INSERT INTO plant(plant_name, species, plant_type, carnivorous, endangered, location) VALUES ('trandafir', 'rosa chinensis', 'magnoliophyta', 'no', 'no', 'left entrance');";
            s.executeUpdate(query);
            query = "INSERT INTO plant(plant_name, species, plant_type, carnivorous, endangered, location) VALUES ('capcana lui Venus', 'dionaea muscipula', 'magnoliophyta', 'yes', 'no', 'left entrance');";
            s.executeUpdate(query);
            query = "INSERT INTO plant(plant_name, species, plant_type, carnivorous, endangered, location) VALUES ('bujor', 'paeonia pregrina', 'magnoliophyta', 'no', 'yes', 'center');";
            s.executeUpdate(query);
            query = "INSERT INTO plant(plant_name, species, plant_type, carnivorous, endangered, location) VALUES ('garofita', 'dianthus callizonus', 'magnoliophyta', 'no', 'yes', 'right entrance');";
            s.executeUpdate(query);
            query = "INSERT INTO plant(plant_name, species, plant_type, carnivorous, endangered, location) VALUES ('ginkgo biloba', 'ginkgo biloba', 'gymnospermae', 'no', 'no', 'back area');";
            s.executeUpdate(query);
            query = "INSERT INTO plant(plant_name, species, plant_type, carnivorous, endangered, location) VALUES ('pin', 'pinus pinea', 'gymnospermae', 'no', 'no', 'left entrance');";
            s.executeUpdate(query);
            query = "INSERT INTO plant(plant_name, species, plant_type, carnivorous, endangered, location) VALUES ('stejar', 'quercus alba', 'angiospermae', 'no', 'yes', 'right entrance');";
            s.executeUpdate(query);
            query = "INSERT INTO plant(plant_name, species, plant_type, carnivorous, endangered, location) VALUES ('salcie', 'salix triandra', 'angiospermae', 'no', 'no', 'back area');";
            s.executeUpdate(query);
